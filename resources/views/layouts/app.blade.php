...
<head>
    ...
    <meta name="google-site-verification" content="6dLp_BmkV6TVRJD_DgeQoQHhxvygdKJ2Ogd1yWjJLzo" />
    <!-- CSRF Token -->
        ...
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel">
            <div class="container-fluid">
                <a class="navbar-brand" href="{{ url('/') }}">
                    <img src="{{asset('img/logo.png')}}" width="auto" height="50" class="d-inline-block align-top d-none d-sm-block" alt="">
