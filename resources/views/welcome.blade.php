                ...
                <div class="card-body">
                     <div class="row">
                        <div class="col-md-4">
                            ...
                            <h4 class="text-info">La UNNE amplía su presencia a escala continental con nuevas movilidades en 2019</h4>
                         ...
                         <div class="col-md-4">
                             <h4 class="text-info">Químico de Dinamarca dictó cursos de Posgrado en Ciencias Exactas</h4>
                        ...
                        <div class="col-md-4">
                             <h4 class="text-info">Se formalizó la doble titulación para la Carrera de Posgrado Maestría en Ciencias de la Ingeniería entre la UNNE y la UFRGS</h4>
