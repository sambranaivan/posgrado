...
/**
    ...
    private function seedCarreras(){
        ...
        $c->save();
        $c->addResolucion('Res. 734/11','Consejo Superior');
        $c->addResolucion('Acreditada Res. 355/12','Coneau');
        $c->addResolucion('Res. 443/16','Ministerial');
        ...
        $c->setUnidadAcademica('arquitectura');
        $c->save();
        $c->addResolucion('Res.Nº152/15 C.S.','Consejo Superior');
        $c->addResolucion('Acreditada (Acta Nº443/16)','Coneau');
        $c->addResolucion(' Res. Nº4074/17 ME','Ministerial');
